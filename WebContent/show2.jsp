								...
								<TD>
									...
									<TABLE cellSpacing=2 cellPadding=1 width="100%" align=center
										...
										<TBODY>
											...
											<c:forEach var="CurrentDish" items="${requestScope.pagemodel.list}"
												varStatus="idx">
														...
														<TR>
															<TD vAlign=top width=90 height=90><A href=#
																target=_blank><IMG height=80 alt=点击图片查看内容
																	src="${CurrentDish.img}" width=80 border=0></A></TD>
															<TD vAlign=top>
																<TABLE cellSpacing=1 cellPadding=0 width="100%"
																	...
																	<TBODY>
																		...
																		<TR>
																			<TD height=21><FONT color=#ff0000>现价：人民币${CurrentDish.price}元</FONT><BR>
																				<a href="#">${CurrentDish.descp}</a>！</TD>
																		</TR>
																	</TBODY>
																</TABLE>
															</TD>
																	...
																	<TBODY>
																		<TR>
																			<TD align="middle" width="70"><a href="#"> <img
																					...
																					longdesc="shoppingCart.html" width="60" height="20">
																			</a></TD>
									...
									<tr>
										<td height="2">
											<div align="left">
												...
												<font color="#000000">当前第</font>&nbsp <font color="#000000">${pagemodel.pageNO}</font>&nbsp
										...
										<td>
											<div align="right">
												<a name="btnTopPage" id="btnTopPage"
													href="loginctrl?action=pagelist&pageNO=${pagemodel.top}"
													title="首页">|&lt;&lt; </a>&nbsp; <a name="btnPreviousPage"
													id="btnPreviousPage"
													href="loginctrl?action=pagelist&pageNO=${pagemodel.prevPage}"
													title="上页"> &lt; </a>&nbsp; <a name="btnNextPage"
													id="btnNextPage"
													href="loginctrl?action=pagelist&pageNO=${pagemodel.nextPage}"
													title="下页"> &gt; </a>&nbsp; <a name="btnBottomPage"
													id="btnBottomPage"
													href="loginctrl?action=pagelist&pageNO=${pagemodel.bottom}"
													title="尾页"> &gt;&gt;|</a>
